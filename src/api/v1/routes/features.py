...
async def list_all_endpoints() -> list[dict[str, Any]]:
    ...
    endpoints = [
        ...
        {
            "method": "GET",
            "path": "/api/v1/features/overview",
            "description": "API feature overview",
            "auth_required": True,
        },
        # Sales V1
        {
            "method": "GET",
            "path": "/api/v1/sales",
            "description": "List sales with basic filtering",
            "auth_required": True,
        },
        # Sales V2 (Enhanced)
        {
            "method": "GET",
            "path": "/api/v2/sales",
            "description": "Enhanced sales with advanced filtering",
            "auth_required": True,
        },
        {
            "method": "POST",
            "path": "/api/v2/sales/analytics",
            "description": "Comprehensive sales analytics",
            "auth_required": True,
        },
        {
            "method": "POST",
            "path": "/api/v2/sales/export",
            "description": "Export sales data",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v2/sales/schema",
            "description": "Get enhanced schema",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v2/sales/performance/benchmark",
        ...
        {
            "method": "GET",
            "path": "/api/v1/datamart/dashboard/overview",
            "description": "Dashboard KPIs",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v1/datamart/sales/analytics",
            "description": "Sales analytics",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v1/datamart/customers/segments",
            "description": "Customer segments",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v1/datamart/customers/{customer_id}/analytics",
            "description": "Customer analytics",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v1/datamart/products/performance",
            "description": "Product performance",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v1/datamart/countries/performance",
            "description": "Country performance",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v1/datamart/trends/seasonal",
            "description": "Seasonal trends",
            "auth_required": True,
        },
        {
            "method": "GET",
            "path": "/api/v1/datamart/metrics/business",
        ...
        {
            "method": "GET",
            "path": "/api/v1/tasks/statistics",
            "description": "Task statistics",
            "auth_required": True,
        },
        {
            "method": "POST",
            "path": "/api/v1/tasks/reports/generate",
            "description": "Generate report",
            "auth_required": True,
        },
        {
            "method": "POST",
            "path": "/api/v1/tasks/etl/process",
            "description": "Process dataset",
            "auth_required": True,
        },
        {
            "method": "POST",
            "path": "/api/v1/tasks/analytics/run",
