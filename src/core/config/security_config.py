...
class SecurityConfig(BaseSettings):
    ...
    oauth2_authorization_url: Optional[str] = Field(default=None)
    oauth2_token_url: Optional[str] = Field(default=None)
    ...
    db_ssl_ca_cert_path: Optional[str] = Field(default=None)
    ...
    password_expiry_days: Optional[int] = Field(default=None)
