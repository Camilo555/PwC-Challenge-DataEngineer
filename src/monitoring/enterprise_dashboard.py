...
from monitoring.advanced_observability import MetricPoint, MetricType, ObservabilityCollector
...
class DashboardManager:
    ...
    def _create_default_dashboards(self):
        ...
        overview_widgets = [
            ...
            DashboardWidget(
                ...
                config={"max_items": 10, "severity_filter": ["error", "critical"]},
            ),
        ]
        ...
        performance_widgets = [
            ...
            DashboardWidget(
                ...
                config={"chart_type": "line", "metrics": ["error_count"], "time_range": 3600},
            ),
        ]
        ...
        business_widgets = [
            ...
            DashboardWidget(
                ...
                config={"chart_type": "gauge", "metrics": ["active_users"], "max_value": 5000},
            ),
        ]
            ...
            for metric_key, metric_deque in self.collector.metrics.items():
                if metric_name in metric_key:
                    ...
                    recent_values.extend(
                        [m.value for m in metric_deque if m.timestamp > cutoff_time]
                    )
    ...
    async def _get_chart_widget_data(self, widget: DashboardWidget) -> dict[str, Any]:
        ...
        return {"type": "chart", "chart_type": chart_type, "data": chart_data}
    ...
    async def _get_alert_widget_data(self, widget: DashboardWidget) -> dict[str, Any]:
        ...
        widget.config.get("severity_filter", [])
        ...
        return {"type": "alert", "data": alert_data, "total_count": len(active_alerts)}
    ...
    async def get_real_time_data(self) -> dict[str, Any]:
        ...
        return {
            ...
            "performance_trends": [
                asdict(trend) for trend in performance_trends[-10:]
            ],  # Last 10 snapshots
