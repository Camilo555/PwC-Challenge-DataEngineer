...
class SimpleBackupCLI:
    ...
    async def backup_full_system(self, validate: bool = True) -> None:
        ...
        try:
            ...
            if results["success"]:
                print(f"[SUCCESS] Full system backup completed successfully!")
                ...
                print(f"[FAILED] Full system backup completed with issues!")
    ...
    async def list_backups(self, component: Optional[str] = None, limit: int = 10) -> None:
