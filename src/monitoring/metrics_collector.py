...
class MetricsCollector:
    ...
    def _init_storage(self):
        ...
        with sqlite3.connect(self.storage_path) as conn:
            ...
            conn.execute(
                "CREATE INDEX IF NOT EXISTS idx_custom_name_timestamp ON custom_metrics(name, timestamp)"
            )
...
def record_etl_run(
    pipeline_name: str, stage: str, records_processed: int, processing_time: float, **kwargs
):
