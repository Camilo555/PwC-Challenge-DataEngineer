...
class DataDogDashboardManager:
    ...
    def __init__(
        self,
        service_name: str = "dashboard-manager",
    ...
    async def create_dashboard(
        ...
        try:
            ...
            self.logger.info(
                f"Dashboard created successfully: {dashboard_title} (ID: {dashboard_id})"
            )
    ...
    def _create_widget(self, widget_config: dict[str, Any], position: int) -> Widget | None:
        ...
        try:
            ...
            if widget_type == "query_value":
                ...
                widget_definition = HeatmapWidgetDefinition(
                    requests=[{"q": query}], title=title, title_size="16", title_align="left"
                )
            else:
            ...
            return Widget(
                ...
                layout={"x": 0, "y": position * 4, "width": 4, "height": 3},
            )
    ...
    async def create_all_dashboards(self) -> dict[str, str | None]:
    ...
    async def update_dashboard(
        ...
        additional_widgets: list[dict[str, Any]] | None = None,
    ) -> bool:
    ...
    async def validate_dashboards(self) -> dict[str, Any]:
        ...
        validation_results = {
            ...
            "validation_results": {},
            "summary": {"accessible": 0, "inaccessible": 0, "errors": []},
        }
...
_dashboard_manager: DataDogDashboardManager | None = None


def get_dashboard_manager(
    service_name: str = "dashboard-manager", datadog_monitoring: DatadogMonitoring | None = None
...
async def create_enterprise_dashboards() -> dict[str, str | None]:
