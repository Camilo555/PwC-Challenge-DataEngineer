...
class BackupManager:
    ...
    def __init__(self, config: BaseConfig, backup_root: Optional[Path] = None):
        self.config = config
    ...
    def get_backup_history(self, component: Optional[str] = None, limit: int = 50) -> List[Dict[str, Any]]:
        """
    ...
    def _get_last_successful_backup(self, component: str) -> Optional[BackupMetadata]:
