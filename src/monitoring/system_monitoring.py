...
class SystemMonitor:
        ...
        try:
            ...
            for proc in psutil.process_iter(
                ...
                try:
                    ...
                    if (
                        pinfo["cpu_percent"] and pinfo["cpu_percent"] > 1.0
    ...
    async def _run_single_health_check(self, health_check: HealthCheck) -> dict[str, Any]:
        ...
        try:
            ...
            result = await asyncio.wait_for(check_func(), timeout=health_check.timeout_seconds)
    ...
    async def check_cpu_usage(self) -> dict[str, Any]:
        ...
        return {"status": status, "value": cpu_percent, "message": message}
    ...
    async def check_memory_usage(self) -> dict[str, Any]:
        ...
        return {"status": status, "value": memory.percent, "message": message}
    ...
    async def check_disk_usage(self) -> dict[str, Any]:
        ...
        return {"status": status, "value": max_usage, "message": message}
    ...
    async def check_load_average(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": status, "value": normalized_load, "message": message}
        except AttributeError:
            # Windows doesn't have load average
            return {
                "status": SystemHealthStatus.HEALTHY,
    ...
    async def check_network_connectivity(self) -> dict[str, Any]:
        ...
        try:
            ...
            active_connections = len(
                [c for c in connections if hasattr(c, "status") and c.status == "ESTABLISHED"]
            )
            ...
            return {"status": status, "value": active_connections, "message": message}
        except Exception as e:
            return {
                "status": SystemHealthStatus.WARNING,
    ...
    def get_system_overview(self) -> dict[str, Any]:
        ...
        return {
            ...
            "health_status": {
                name: check.status.value for name, check in self.health_checks.items()
            },
