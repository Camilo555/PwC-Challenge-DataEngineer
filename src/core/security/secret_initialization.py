...
class SecretInitializer:
    ...
    async def rotate_secrets(self, secret_keys: Optional[List[str]] = None) -> Dict[str, str]:
        """
...
_secret_initializer: Optional[SecretInitializer] = None
...
async def cli_rotate_secrets(secret_names: Optional[List[str]] = None) -> None:
