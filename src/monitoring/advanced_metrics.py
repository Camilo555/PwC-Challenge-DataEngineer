...
class MetricCollector:
    ...
    def increment_counter(self, name: str, value: Union[int, float] = 1, labels: Optional[Dict[str, str]] = None) -> None:
    ...
    def _record_metric(self, name: str, expected_type: MetricType, value: Union[int, float], labels: Optional[Dict[str, str]] = None) -> None:
...
_global_metrics_collector: Optional[MetricCollector] = None


def get_metrics_collector(storage: Optional[MetricStorage] = None) -> MetricCollector:
...
def setup_metrics_collection(storage: Optional[MetricStorage] = None) -> MetricCollector:
