...
class ConfigCacheManager:
    ...
    def __init__(
        ...
        # Statistics
        self.stats = {"hits": 0, "misses": 0, "reloads": 0, "validations": 0, "errors": 0}
    ...
    async def set_config(
        ...
        try:
            ...
            success = await cache_manager.set(cache_key, validated_value, cache_ttl, self.namespace)
            ...
            if success:
                ...
                await publish_cache_invalidation(
                    f"config_change:{key}", self.namespace, source="config_cache_manager"
                )
                ...
                try:
                    ...
                    if loaded_value is not None:
                        ...
                        await self.set_config(
                            key, loaded_value, config_type=ConfigType.APPLICATION, version=version
                        )
                        return loaded_value
    ...
    async def load_config_file(
        ...
        try:
            ...
            if not isinstance(config_data, dict):
                ...
                return await self.set_config(config_key, config_data, config_type, ttl)
    ...
    def _add_watched_file(self, file_path: str, key_prefix: str = ""):
        ...
        if abs_path not in self.watched_files:
            ...
            self.file_observer.schedule(FileWatcherHandler(self), directory, recursive=False)
    ...
    async def get_config_metadata(self, key: str, version: str = "latest") -> ConfigEntry | None:
    ...
    async def invalidate_config(self, key: str, version: str = "latest") -> bool:
        ...
        await publish_cache_invalidation(
            f"config_invalidate:{key}", self.namespace, source="config_cache_manager"
        )
...
_config_cache_manager: ConfigCacheManager | None = None
...
def config_property(
    key: str, default: Any = None, config_type: ConfigType = ConfigType.APPLICATION
):
