...
class SalesTransactionBase(SQLModel):
    ...
    customer_id: Optional[str] = SQLField(default=None, index=True, max_length=50)
...
class SalesTransaction(SalesTransactionBase, table=True):
    ...
    total_amount: Optional[Decimal] = SQLField(
        default=None,
        max_digits=12,
        decimal_places=2,
    ...
    payment_method: Optional[PaymentMethod] = SQLField(default=None)
