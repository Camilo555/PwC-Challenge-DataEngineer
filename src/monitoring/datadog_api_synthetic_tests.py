...
class DataDogAPISyntheticTests:
        ...
        return [
            ...
            APIEndpointConfig(
                ...
                data_validation_rules=[
                    {"type": "jsonpath", "path": "$.total_revenue", "operator": "exists"},
                    {
                        "type": "jsonpath",
                ...
                steps=[
                    APITestStep(
                        ...
                        assertions=[
                            ...
                            {"type": "jsonpath", "path": "$.access_token", "operator": "exists"},
                        ],
                        extract_variables=[
                            {"name": "AUTH_TOKEN", "type": "jsonpath", "path": "$.access_token"}
                        ],
                    ),
                    APITestStep(
                        name="Validate Token",
            ...
            WorkflowTestConfig(
                ...
                steps=[
                    APITestStep(
                        ...
                        extract_variables=[
                            {"name": "TOTAL_REVENUE", "type": "jsonpath", "path": "$.total_revenue"}
                        ],
                    ),
                    APITestStep(
            ...
            WorkflowTestConfig(
                ...
                steps=[
                    ...
                    APITestStep(
                        ...
                        assertions=[{"type": "statusCode", "operator": "is", "target": 200}],
                        extract_variables=[
                            {"name": "FEATURE_COUNT", "type": "jsonpath", "path": "$.feature_count"}
                        ],
                    ),
                    APITestStep(
                        ...
                        assertions=[
                            {"type": "statusCode", "operator": "is", "target": 200},
                            {"type": "jsonpath", "path": "$.prediction", "operator": "exists"},
                            {
                                "type": "jsonpath",
                                "path": "$.confidence",
                                "operator": "isType",
                ...
                steps=[
                    APITestStep(
                        ...
                        assertions=[
                            ...
                            {"type": "jsonpath", "path": "$.period", "operator": "exists"},
                        ],
                    ),
                    APITestStep(
    ...
    async def deploy_endpoint_tests(
        self,
        ...
        try:
            for endpoint_config in self.api_endpoints:
                test_config = SyntheticTestConfig(
                    ...
                    if endpoint_config.business_critical
    ...
    async def deploy_workflow_tests(
        self,
        locations: list[TestLocation] = None,
        ...
        try:
            for workflow_config in self.workflows:
                test_config = SyntheticTestConfig(
                    ...
                    locations=locations,
                    alert_condition=AlertCondition.FAST
                    if workflow_config.critical_workflow
                    else AlertCondition.SLOW,
                ...
                test_id = await self.synthetic_monitoring.create_multistep_api_test(
                    workflow_config.name, workflow_config.steps, test_config
                )
    ...
    async def deploy_sla_compliance_tests(
        self, locations: list[TestLocation] = None
    ) -> dict[str, str]:
        ...
        try:
            ...
            for result in all_results:
                ...
                perf["avg_response_time"] = (
                    (perf["avg_response_time"] * (perf["total_executions"] - 1))
            ...
            for endpoint_perf in endpoint_performance.values():
                endpoint_perf["success_rate"] = (
                    (
                        endpoint_perf["successful_executions"]
                        / endpoint_perf["total_executions"]
                        * 100
                    )
                    if endpoint_perf["total_executions"] > 0
                    else 0.0
                )
