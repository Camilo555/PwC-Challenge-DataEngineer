...
class CorrelationMiddleware(BaseHTTPMiddleware):
    ...
    def _extract_correlation_context(self, request: Request) -> Dict[str, Optional[str]]:
    ...
    def _extract_user_from_jwt(self, auth_header: Optional[str]) -> Optional[str]:
    ...
    def _add_correlation_headers(self, response: Response, context: Dict[str, Optional[str]]) -> Response:
        """Add correlation headers to response."""
...
def extract_correlation_headers(headers: Dict[str, str]) -> Dict[str, Optional[str]]:
