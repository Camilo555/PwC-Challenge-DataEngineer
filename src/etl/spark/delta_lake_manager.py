...
from pyspark.sql.functions import col, current_timestamp, expr, hash, lit
...
class DeltaLakeManager:
    ...
    def optimize_table(self, layer: str, table_name: str, z_order_cols: list[str] | None = None):
...
def create_delta_lake_manager(spark: SparkSession | None = None) -> DeltaLakeManager:
