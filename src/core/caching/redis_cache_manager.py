...
try:
    ...
    # Mock Redis classes for when redis is not available
    REDIS_AVAILABLE = False
    redis = None
    aioredis = None

    class MockRedisConnection:
        """Mock Redis connection for testing without Redis dependency"""
...
class RedisCacheManager:
    ...
    def __init__(self, config: RedisConfig | None = None, key_prefix: str = "pwc:"):
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            Retry(ExponentialBackoff(), retries=3)
    ...
    async def _init_sentinel(self):
        ...
        try:
            sentinel_hosts = [
                (host.split(":")[0], int(host.split(":")[1])) for host in self.config.sentinel_hosts
            ]
    ...
    async def set_multi(
        self, data: dict[str, Any], ttl: int | None = None, namespace: str = ""
    ) -> bool:
    ...
    async def smembers(self, name: str, namespace: str = "") -> builtins.set[Any]:
