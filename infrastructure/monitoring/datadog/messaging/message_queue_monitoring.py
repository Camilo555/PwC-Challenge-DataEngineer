...
class DataDogMessageQueueMonitor:
                        ...
                        for group_info in consumer_groups:
                            ...
                            try:
                                ...
                                if group_id in group_description:
                                    # group_state = group_description[group_id].state  # Not used currently
    ...
    async def _check_kafka_alerts(self, kafka_name: str, metrics: dict[str, Any], tags: list[str]):
        ...
        self.performance_baselines['kafka']
        ...
        if controller_id < 0:
            statsd.event(
                ...
                text="No active controller found in cluster",
                alert_type='error',
                tags=tags
            )
        ...
        if broker_count == 0:
            statsd.event(
                ...
                text="No brokers available in cluster",
                alert_type='error',
                tags=tags
            )
